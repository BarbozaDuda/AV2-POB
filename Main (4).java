...
public class Main {
  ...
  //	ca.listar(camas);
    ...
    q.incluir(quartos, 1, "A10", 3, true, "Quarto em Cabo frio com vista para o mar");
    q.incluir(quartos, 2, "A20", 2, false, "Quarto Luxuosos");
  //	q.alterarCliente(quartos, 4, 1, "false");
    q.listarQuartos(quartos);
  //	q.excluirQuarto(quartos, 2);


    c.incluir(clientes, 2, 100, "Jardim guanabara", 1120, "Brasil", "132.232.321", 11223344, "maria@gmail.com",
        "25/11/2004");
    c.incluir(clientes, 3, 100, "Barra", 2020, "Brasil", "132.232.111", 11000344, "duda@gmail.com",
        "25/11/2006");
    c.incluir(clientes, 4, 100, "Ilha", 3020, "Brasil", "132.222.321", 11113344, "manu@gmail.com",
        "25/11/2010");
